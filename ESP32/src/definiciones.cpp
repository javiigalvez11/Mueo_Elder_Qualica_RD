...
// =================== Valores de configuración ===================
    String DEVICE_ID = "ME011";
    String ssid = "ME011_WIFI";
    String password = "Elder";
    String credencialMaestra = "Qualicard";
    uint32_t aperturasTotales = 0;
    String sentido = "Entrada"; // "Entrada" o "Salida"
    // String serverURL = "http://192.168.1.207:8537/PTService/ESP32";
    String serverURL = "http://validaciones.museoelder.es:8537/PTService/ESP32";
    // String serverURL = "http://192.168.8.4:8084/PTService/ESP32";
    String urlActualiza = "https://grupocayp.es/wp-content/uploads/ME011.bin";
    
    // === Red (W5500) ===
    uint8_t modoRed = 0; // 0 DHCP, 1 IP fija

    IPAddress IP = IPAddress(192, 168, 1, 194);
    ...
    //uint8_t MAC[6];
// =================== Versión ===================
    String enVersion = "2.6";
    String versionAnterior = "2.5";
